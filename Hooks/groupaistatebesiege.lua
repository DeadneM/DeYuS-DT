...
local DontBlockPhalanx = true
function GroupAIStateBesiege:_check_spawn_phalanx()
	--not Global.game_settings.single_player
	if DontBlockPhalanx and self._phalanx_center_pos and self._task_data and self._task_data.assault.active and not self._phalanx_spawn_group and (self._task_data.assault.phase == "build" or self._task_data.assault.phase == "sustain") then
